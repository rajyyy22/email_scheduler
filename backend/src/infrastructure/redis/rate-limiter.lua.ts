// Embedded Redis Lua Script for Atomic Rate-Limiting & Delayed Slot Reservation
export const RATE_LIMITER_LUA_SCRIPT = `-- Redis Lua Script for Atomic Rate-Limiting & Delayed Slot Reservation
-- KEYS:
